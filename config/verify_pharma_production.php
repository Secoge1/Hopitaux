<?php
/**
 * Vérification configuration production PharmaPro — pharmasmart.secogesarl.com
 * Usage CLI : php config/verify_pharma_production.php
 */
$_SERVER['HTTP_HOST'] = 'pharmasmart.secogesarl.com';
$_SERVER['HTTPS'] = 'on';
...
vp_check('SITE_URL', defined('SITE_URL') && SITE_URL === 'https://pharmasmart.secogesarl.com', SITE_URL ?? '');
