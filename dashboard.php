...
$dashLinks = app_home_dash_links($auth);
$dateFr = app_home_date_fr();

app_head('Dashboard', ['assets/css/app-home.css'], 'app-home-page');
app_layout_start([
    'active'           => 'dashboard',
    ...
    <div class="home-hero-inner">
        <div class="home-hero-greeting">
            <div class="home-hero-eyebrow">
                ...
                Dashboard · <?= htmlspecialchars($dateFr) ?>
            </div>
            <h1>Vue d'ensemble analytique</h1>
            <p>
                Indicateurs clés et activité du jour pour <strong><?= htmlspecialchars(getNomEtablissement()) ?></strong>.
            ...
            <div class="home-hero-meta">
                ...
                <span class="home-pill"><i class="fas fa-bolt"></i>Temps réel</span>
                <?php if (!empty($stats['last_updated'])): ?>
                <span class="home-pill"><i class="fas fa-clock"></i><span data-last-updated><?= htmlspecialchars($stats['last_updated']) ?></span></span>
                <?php endif; ?>
            </div>
        </div>
        <div class="home-hero-actions">
            ...
            <a href="<?= app_url('index.php') ?>" class="home-hero-btn home-hero-btn--solid">
...
<div class="home-layout">
    <div class="home-main">
        ...
        <?php if (!empty($dashLinks)): ?>
        <div class="home-panel">
            <div class="home-panel-head"><i class="fas fa-link"></i>Accès directs</div>
            <div class="home-panel-body">
                <div class="home-dash-links">
                    <?php foreach ($dashLinks as $link): ?>
                    <a href="<?= app_url($link['href']) ?>" class="home-dash-link">
        ...
        <?php app_home_render_modules_grid($homeModules, 'dashModuleSearch'); ?>
    </div>
        ...
        <div class="home-panel">
            ...
            <div class="home-panel-body">
                ...
                <ul class="home-info-list">
                    ...
                    <?php if (!empty($stats['last_updated'])): ?>
                    <li><span>Données</span><span data-last-updated><?= htmlspecialchars($stats['last_updated']) ?></span></li>
                    <?php endif; ?>
                </ul>
...
<script>
(function () {
    var input = document.getElementById('dashModuleSearch');
